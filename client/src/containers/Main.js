...
class Main extends Component {
  ...
  handleSearchSubmit() {
    ...
    const url = `http://localhost:8080/locations/${sortBy}/lat=${
      this.state.location.lat
    }/long=${this.state.location.long}/dis=${this.state.distance}`;
            ...
            <div className="body-content">
              <Switch>
                ...
                <Route
                  path="/art/:id"
                  render={() => (
                    <ArtView selectedArtView={this.state.selectedArtView} />
                  )}
                />
